...
class Signal {
    ...
    dispatch(e) {
        for (var t = this._listeners.length, n = 0; n < t; ++n) this._listeners[n](e)
    }
...
class AssetLibrary {
    ...
    _texture2D (e, t) {
        ...
        r.wrapS = THREE.RepeatWrapping, r.wrapT = THREE.RepeatWrapping, r.minFilter = THREE.LinearMipMapLinearFilter, r.magFilter = THREE.LinearFilter, highPerformance && (r.anisotropy = 16)
    }
    _model (e, t, n) {
        var i = this,
            r = new n;
        r.options = r.options || {}, r.options.convertUpAxis = !0, r.load(e, function (e) {
...
function AsyncTaskQueue() {
    this.onComplete = new Signal, this.onProgress = new Signal, this._queue = [], this._childQueues = [], this._currentIndex = 0, this._isRunning = !1
}

function DoubleBufferTexture(e, t, n) {
    this._width = e, this._height = t, this._sourceFBO = new THREE.WebGLRenderTarget(e, t, n), this._targetFBO = new THREE.WebGLRenderTarget(e, t, n), this._sourceFBO.texture.generateMipmaps = n.generateMipmaps || !1, this._targetFBO.texture.generateMipmaps = n.generateMipmaps || !1
}
...
function RectRenderer(e, t) {
    this._renderer = e, this._scene = new THREE.Scene, this._camera = new THREE.OrthographicCamera((-1), 1, 1, (-1), 0, 1), this._mesh = t || new THREE.Mesh(new THREE.PlaneBufferGeometry(2, 2), null), this._scene.add(this._mesh)
}


function SPHCollider(e) {
    this._target = null, this._invalid = !0, this._material = e
}

function startUp() {
    highPerformance = !isPlatformMobile() && !QueryString.lowPerformance, assetLibrary = new AssetLibrary("assets/"), assetLibrary.queueAsset("skybox", "textures/skybox/specular/", AssetLibrary.Type.TEXTURE_CUBE), assetLibrary.queueAsset("irradiance", "textures/skybox/irradiance/", AssetLibrary.Type.TEXTURE_CUBE), assetLibrary.queueAsset("cascademap", "textures/cascademap.jpg", AssetLibrary.Type.TEXTURE_2D), assetLibrary.onComplete.bind(onAssetsLoaded), assetLibrary.onProgress.bind(onAssetsProgress), assetLibrary.load()
}
...
window.start = function(e, t) {
    e = SPH.Quality.LOW
    t = SPHContent.BALL_MODE
    var n = document.getElementById("playContainer");
    if (n.style.display = "none", mainProject = new SimpleThreeProject, mainProject.init(debugMode, assetLibrary), verifyExtension("EXT_blend_minmax") && verifyExtension("OES_texture_float_linear") && verifyExtension("EXT_frag_depth")) {
        ...
        r && (r.style.display = debugMode ? "block" : "none"), mainProject.content = new SPHContent(t, e), mainProject.start()
    }
}
...
function verifyExtension(e) {
    ...
    if (!t) {
        ...
        n.style.display = "block", n = document.getElementById("errorMessage"), n.innerHTML = "This requires the WebGL " + e + " extension!"
    }
    return t
}
...
function VolumetricLightRenderer(e, t, n, i, r, o) {
    ...
    }), this._renderer = e, this._scene = new THREE.Scene, this._rectRenderer = new RectRenderer(e), this._material = new VolumetricLighting(t, n, i, r)
}
...
function VolumetricNormalsRenderer(e, t, n, i) {
    this._renderer = e, this._scene = new THREE.Scene, this._camera = new THREE.OrthographicCamera((-1), 1, 1, (-1), 0, 1), this._material = new VolumetricNormals(t, n, i), this._quad = new THREE.Mesh(new THREE.PlaneBufferGeometry(2, 2), this._material), this._scene.add(this._quad)
}
...
THREEx.RendererStats = function () {
    ...
    t.style.cssText = "padding:0 0 3px 3px;text-align:left;background-color:#200;", e.appendChild(t);
    var n = document.createElement("div");
    n.style.cssText = "color:#f00;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px", n.innerHTML = "WebGLRenderer", t.appendChild(n);
    for (var i = [], r = 9, o = 0; o < r; o++) i[o] = document.createElement("div"), i[o].style.cssText = "color:#f00;background-color:#311;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px", t.appendChild(i[o]), i[o].innerHTML = "-";
    var a = Date.now();
    return {
        domElement: e,
        update (e) {
            if (console.assert(e instanceof THREE.WebGLRenderer), !(Date.now() - a < 1e3 / 30)) {
                a = Date.now();
                var t = 0;
                i[t++].textContent = "== Memory =====", i[t++].textContent = "Programs: " + e.info.memory.programs, i[t++].textContent = "Geometries: " + e.info.memory.geometries, i[t++].textContent = "Textures: " + e.info.memory.textures, i[t++].textContent = "== Render =====", i[t++].textContent = "Calls: " + e.info.render.calls, i[t++].textContent = "Vertices: " + e.info.render.vertices, i[t++].textContent = "Faces: " + e.info.render.faces, i[t++].textContent = "Points: " + e.info.render.points
            }
        }
    }
}, THREE.RenderPass = function (e, t, n, i, r) {
    THREE.Pass.call(this), this.scene = e, this.camera = t, this.overrideMaterial = n, this.clearColor = i, this.clearAlpha = void 0 !== r ? r : 0, this.clear = !0, this.needsSwap = !1
    ...
    render (e, t, n, i, r) {
        ...
        var a, s;
        this.clearColor && (a = e.getClearColor().getHex(), s = e.getClearAlpha(), e.setClearColor(this.clearColor, this.clearAlpha)), e.render(this.scene, this.camera, this.renderToScreen ? null : n, this.clear), this.clearColor && e.setClearColor(a, s), this.scene.overrideMaterial = null, e.autoClear = o
    }
...
class Axes extends THREE.Object3D {
    _init(){
        ...
        t.rotation.z = .5 * -Math.PI, i.rotation.x = .5 * Math.PI, this.add(t), this.add(n), this.add(i)
    }
}
...
const CalculateNormals = {
    doAll (e) {
        for (var t = 0; t < e.children.length; ++t) {
            var n = e.children[t];
            n.geometry && (n.geometry.computeVertexNormals(!1), n.geometry.normalsNeedUpdate = !0), CalculateNormals.doAll(n)
        }
    }
};
...
var CopyDataToRenderTarget = {
    execute (e, t, n, i) {
        ...
        s.uniforms.tDiffuse.value = a, r.execute(s, t)
    }
};
...
const FindObject3D = {
    findByNamePartial (e, t, n) {
        void 0 === n && (n = []);
        for (var i = 0; i < e.children.length; ++i) {
            var r = e.children[i];
            r.name.indexOf(t) >= 0 && n.push(r), FindObject3D.findByNamePartial(r, t, n)
        }
        return n
    }
};
...
RectRenderer.prototype = {
        execute (e, t, n, i) {
            ...
            this._renderer.autoClear = void 0 === n || n, this._mesh.material = e, this._renderer.render(this._scene, i || this._camera, t), this._renderer.autoClear = r
        },
        clear (e) {
            this._renderer.setRenderTarget(e), this._renderer.clear()
        }
}
...
const SwapMaterials = {
    ...
    swapSelect (e, t) {
        for (var n = 0; n < e.children.length; ++n) {
            var i = e.children[n];
            t.hasOwnProperty(i.name) && (i.material = t[i.name]), SwapMaterials.swapSelect(i, t)
        }
    },
    swapSelectPartialMatch (e, t) {
        for (var n = 0; n < e.children.length; ++n) {
            var i = e.children[n];
...
class TripleBufferTexture {
    constructor(e, t, n) {
        this._width = e, this._height = t, this._storedFBO = new THREE.WebGLRenderTarget(e, t, n), this._sourceFBO = new THREE.WebGLRenderTarget(e, t, n), this._targetFBO = new THREE.WebGLRenderTarget(e, t, n), this._storedFBO.texture.generateMipmaps = n.generateMipmaps || !1, this._sourceFBO.texture.generateMipmaps = n.generateMipmaps || !1, this._targetFBO.texture.generateMipmaps = n.generateMipmaps || !1
    }
    get width() {
        return this._width
    }
    ...
    store() {
        ...
        this._storedFBO = this._targetFBO, this._targetFBO = e
    }
...
class EntityEngine {
    ...
    registerEntity (e) {
        e._onRequireUpdatesChange.bind(this._onEntityUpdateChange, this), e._requiresUpdates && this._addUpdatableEntity(e)
    }
    unregisterEntity (e) {
        e._onRequireUpdatesChange.unbind(this), e._requiresUpdates && this._removeUpdatableEntity(e)
    }
    destroyEntity (e) {
        e._onRequireUpdatesChange.unbind(this), e._requiresUpdates && this._removeUpdatableEntity(e), this._destroyQueue.push(e)
    }
    ...
    _processDestroyQueue () {
        ...
        if (0 !== e) {
            for (var t = 0; t < e; ++t) {
                ...
                delete n._components, delete n._requiresUpdates, delete n._onRequireUpdatesChange, delete n._update, delete n._updateRequiresUpdates
            }
            this._destroyQueue = []
        }
    }
    update(e) {
        ...
        for (var t = this._updateableEntities, n = t.length, i = 0; i < n; ++i) t[i]._update(e)
    }
}
...
class Entity {
    ...
    addComponents (e, t) {
        for (var n = 0; n < t.length; ++n) this.addComponent(e, t[n])
    }
    removeComponents (e, t) {
        for (var n = 0; n < t.length; ++n) this.removeComponent(e, t[n])
    }
    addComponent (e, t) {
        if (t._entity) throw new Error("Component already added to an entity!");
        this.convert(e), e._components.push(t), e._updateRequiresUpdates(this._requiresUpdates || !!t.onUpdate), t._entity = e, t.onAdded()
    }
    hasComponent (e, t) {
        return e._components && e._components.indexOf(t) >= 0
    }
    removeComponent (e, t) {
        if (!this.hasComponent(e, t)) throw new Error("Component wasn't added to this entity!");
        t.onRemoved();
        for (var n = !1, i = e._components.length, r = 0, o = [], a = 0; a < i; ++a) {
            var s = e._components[a];
            s !== t && (o[r++] = s, n = n || !!t.onUpdate)
        }
        e._components = 0 === r ? null : o, t._entity = null, e._updateRequiresUpdates(n)
    }
}

class EntityPrototype{
    _init (e) {
        e._components = [], e._requiresUpdates = !1, e._onRequireUpdatesChange = new Signal, e._update = function (e) {
    ...
    ShaderLibrary["sph_distance_vertex.glsl"] = "attribute vec2 positionUV;\n\nuniform sampler2D positionBuffer;\nuniform vec3 numCells;\nuniform float cellSize;\nuniform float particleRadius;\nuniform float zSliceOffset;\n\nvarying vec3 particlePosition;\n\nvoid main() {\n    vec4 localPos = vec4(texture2D(positionBuffer, positionUV).xyz, 1.0);\n    vec2 uv = getBucketUV(localPos.xyz, numCells, cellSize);\n    uv.x += zSliceOffset / numCells.z;\n\n    gl_Position = vec4(uv * 2.0 - 1.0, 0.0, 1.0);\n\n    float rad = cos(zSliceOffset * cellSize / particleRadius * PI * .5);\n    float pointSize = ceil(particleRadius / cellSize * 2.0 * rad) + 1.0;\n    gl_PointSize = pointSize;\n\n    particlePosition = localPos.xyz;\n}", ShaderLibrary["sph_heightmap_collider_fragment.glsl"] = "uniform vec3 wallExtent;\nuniform vec3 numCells;\nuniform float cellSize;\nuniform vec3 spherePosition;\nuniform float sphereRadius;\n\nuniform sampler2D heightMap;\n\nfloat getDistance(vec3 pos)\n{\n    float wallDist = signedDistanceWalls(pos, wallExtent);\n\n    // this is not entirely correct, but let's hope it's good enough\n    vec3 size = numCells * cellSize;\n    vec2 uv = pos.xz / size.xz + .5;\n    uv.y = 1.0 - uv.y;\n    float y =(texture2D(heightMap, uv).x - .5) * size.y;\n    float heightMapDist = pos.y - y;\n\n    return min(wallDist, heightMapDist);\n}\n\nvec3 getNormal(vec3 pos)\n{\n    float r = getDistance(pos + vec3(cellSize, 0.0, 0.0));\n    float l = getDistance(pos - vec3(cellSize, 0.0, 0.0));\n    float t = getDistance(pos + vec3(0.0, cellSize, 0.0));\n    float b = getDistance(pos - vec3(0.0, cellSize, 0.0));\n    float n = getDistance(pos + vec3(0.0, 0.0, cellSize));\n    float f = getDistance(pos - vec3(0.0, 0.0, cellSize));\n\n    // normalization happens in collision test anyway, so no need for it here\n    return normalize(vec3(r - l, t - b, n - f));\n}\n\nvoid main() {\n    vec3 pos = getCellPositionFromFragCoord(gl_FragCoord.xy, numCells, cellSize);\n    float dist = getDistance(pos);\n    vec3 normal = getNormal(pos);\n\n    gl_FragColor = vec4(normal, dist);\n}\n", ShaderLibrary["sph_init_velocity_still.glsl"] = "vec3 initVelocity(float index, vec3 numCells, float cellSize)\n{\n    return vec3(0.0);\n}", ShaderLibrary["sph_init_velocity_stream.glsl"] = "vec3 initVelocity(float index, vec3 numCells, float cellSize)\n{\n    return vec3(numCells.x, 0.0, numCells.y) * cellSize;\n}", ShaderLibrary["sph_particle_depth_fragment.glsl"] = "varying float radius;\nvarying vec2 centerFrag;\nvarying vec3 viewPosition;\n\nuniform float particleSize;\nuniform float cameraNear;\nuniform float rcpCameraRange;\nuniform mat4 projectionMatrix;\n\nvoid main() {\n    float radius2 = radius * radius;\n    vec2 diff = gl_FragCoord.xy - centerFrag;\n    diff /= radius;\n    float dist2 = dot(diff, diff);\n    if (dist2 > 1.0) discard;\n\n    vec3 normal;\n    normal.xy = diff;\n    normal.z = sqrt(1.0 - dist2);\n\n    vec3 pos = viewPosition - normal * particleSize;\n    float linearDepth = (-pos.z - cameraNear) * rcpCameraRange;\n\n    gl_FragColor = floatToRGBA8(linearDepth);\n    gl_FragDepthEXT = linearDepth;\n}\n", ShaderLibrary["sph_particle_depth_vertex.glsl"] = "attribute vec2 positionUV;\n\nuniform sampler2D positionBuffer;\nuniform float particleSize;\nuniform vec2 viewportSize;\n\nvarying float radius;\nvarying vec2 centerFrag;\nvarying vec3 viewPosition;\n\nvoid main() {\n    vec4 localPos = vec4(texture2D(positionBuffer, positionUV).xyz, 1.0);\n    vec4 viewPos = modelViewMatrix * localPos;\n    gl_Position = projectionMatrix * viewPos;\n    radius = -projectionMatrix[1][1] * particleSize / viewPos.z * viewportSize.y;\n    gl_PointSize = radius * 2.0;\n\n    centerFrag = (gl_Position.xy / gl_Position.w + 1.0) * viewportSize * .5;\n\n    viewPosition = viewPos.xyz;\n}", ShaderLibrary["sph_particle_point_fragment.glsl"] = "#ifdef MAP\nuniform sampler2D colorBuffer;\n\nvarying vec2 texCoords;\n#endif\n\nvoid main() {\n#ifdef MAP\n    gl_FragColor.xyz = (.5 + length(texture2D(colorBuffer, texCoords).xyz)) * vec3(.5, .8, 1.0) * .5;\n    gl_FragColor.w = 1.0;\n#else\n    gl_FragColor = vec4(1.0);\n#endif\n}\n", ShaderLibrary["sph_particle_point_vertex.glsl"] = "attribute vec2 positionUV;\n\nuniform sampler2D positionBuffer;\nuniform float particleSize;\n\n#ifdef MAP\nvarying vec2 texCoords;\n#endif\n\nvoid main() {\n    vec4 localPos = vec4(texture2D(positionBuffer, positionUV).xyz, 1.0);\n    vec4 viewPos = modelViewMatrix * localPos;\n    gl_Position = projectionMatrix * viewPos;\n    gl_PointSize = particleSize;\n\n    #ifdef MAP\n    texCoords = positionUV;\n    #endif\n\n}", ShaderLibrary["sph_position_fragment.glsl"] = "varying vec2 texCoords;\nuniform sampler2D velocityBuffer;\nuniform sampler2D positionBuffer;\nuniform sampler2D accelBuffer;\n\nuniform float dt;\nuniform vec3 wallExtent;\nuniform float maxParticleIndex;\n\nvoid main() {\n    vec4 posSample = texture2D(positionBuffer, texCoords);\n    vec3 a_i = texture2D(accelBuffer, texCoords).xyz;\n    vec3 v_i = texture2D(velocityBuffer, texCoords).xyz;\n    vec3 x_i = posSample.xyz;\n    float thisIndex = posSample.w;\n\n    vec3 x_i_1 = x_i + dt * (v_i + .5 * a_i * dt);\n\n//    x_i_1 = min(x_i_1, wallExtent);\n//    x_i_1 = max(x_i_1, -wallExtent);\n\n    if (thisIndex > maxParticleIndex)\n        x_i_1 = x_i;\n\n    gl_FragColor = vec4(x_i_1, thisIndex);\n}\n", ShaderLibrary["sph_quad_vertex.glsl"] = "varying vec2 texCoords;\n\nvoid main() {\n    texCoords = uv;\n    gl_Position = vec4(position, 1.0);\n}", ShaderLibrary["sph_velocity_fragment.glsl"] = "varying vec2 texCoords;\nuniform sampler2D positionBuffer;\nuniform sampler2D velocityBuffer;\nuniform sampler2D accelBuffer1;\nuniform sampler2D accelBuffer2;\nuniform sampler2D collisionBuffer;\n\nuniform float dt;\nuniform vec3 numCells;\nuniform float cellSize;\nuniform float restDistance;\nuniform float maxParticleIndex;\n\nvoid main() {\n    vec4 posSample = texture2D(positionBuffer, texCoords);\n    vec3 a_i = texture2D(accelBuffer1, texCoords).xyz;\n    vec3 a_i_p = texture2D(accelBuffer2, texCoords).xyz;\n    vec3 v_i = texture2D(velocityBuffer, texCoords).xyz;\n    vec3 x_i = posSample.xyz;\n    float thisIndex = posSample.w;\n\n    vec3 v_i_1 = v_i + dt * (a_i + a_i_p) * .5;\n\n    vec3 x_i_1 = x_i + v_i_1 * dt;\n    vec4 boundSample = sampleCellLinear(collisionBuffer, x_i_1, numCells, cellSize);\n    vec3 wallNormal = normalize(boundSample.xyz);\n    float wallDist = max(restDistance * 2.0 - boundSample.w, 0.0);\n    // move the particle back to the correct rest distance, this enforces no-slip condition on velocity\n    x_i_1 += wallDist * wallNormal;\n    // update the velocity to match\n    v_i_1 = (x_i_1 - x_i) / dt;\n\n    if (thisIndex > maxParticleIndex)\n        v_i_1 = initVelocity(thisIndex, numCells, cellSize);\n\n    gl_FragColor = vec4(v_i_1, 1.0);\n}\n", ShaderLibrary["sph_wall_collider_fragment.glsl"] = "uniform vec3 wallExtent;\nuniform vec3 numCells;\nuniform float cellSize;\n\nfloat getDistance(vec3 pos)\n{\n    return signedDistanceWalls(pos, wallExtent);\n}\n\nvec3 getNormal(vec3 pos)\n{\n    float r = getDistance(pos + vec3(cellSize, 0.0, 0.0));\n    float l = getDistance(pos - vec3(cellSize, 0.0, 0.0));\n    float t = getDistance(pos + vec3(0.0, cellSize, 0.0));\n    float b = getDistance(pos - vec3(0.0, cellSize, 0.0));\n    float n = getDistance(pos + vec3(0.0, 0.0, cellSize));\n    float f = getDistance(pos - vec3(0.0, 0.0, cellSize));\n\n    // normalization happens in collision test anyway, so no need for it here\n    return normalize(vec3(r - l, t - b, n - f));\n}\n\nvoid main() {\n    vec3 pos = getCellPositionFromFragCoord(gl_FragCoord.xy, numCells, cellSize);\n    float dist = getDistance(pos);\n    vec3 normal = getNormal(pos);\n\n    gl_FragColor = vec4(normal, dist);\n}\n", SPHCollider.prototype = {
        ...
        init (e, t) {
            this._renderer = t, this._halfFloatType = FloatTex.getHalfOrFloat(t), this._rectRenderer = new RectRenderer(t), this._numCells = e.numCells, this._cellSize = e.cellSize, this._target = new THREE.WebGLRenderTarget(this._numCells.x * this._numCells.z, this._numCells.y, {
            ...
            n.numCells.value = this._numCells, n.wallExtent.value = e.halfExtent, n.cellSize.value = this._cellSize
        },
        invalidate () {
            this._invalid = !0
        },
...
class BillboardComponent {
    constructor (e, t) {
        this._camera = e, this._constantSize = t, this._v = new THREE.Vector3
        this.constantSize = {
            get () {
    ...
    onAdded = function () {}
    onUpdate = function (e) {
        this._v.setFromMatrixPosition(this._camera.matrixWorld), this.entity.lookAt(this._v), this._constantSize && (this._v.copy(this.entity.position), this._v.applyMatrix4(this._camera.matrixWorldInverse), this.entity.scale.set(-this._v.z, -this._v.z, -this._v.z))
    }
...
class OrbitController extends Component{
    constructor(e, t, n) {
        super();
        this.enabled = !0, this._container = e, this._coords = new THREE.Vector3(0, .4 * Math.PI, 2), this._localAcceleration = new THREE.Vector3(0, 0, 0), this._localVelocity = new THREE.Vector3(0, 0, 0), this.lookAtTarget = t || new THREE.Vector3(0, 0, 0), this.zoomSpeed = 2, this.maxRadius = 20, this.minRadius = .1, this.dampen = .9, this.maxAzimuth = void 0, this.minAzimuth = void 0, this.minPolar = .1, this.maxPolar = Math.PI - .1, this.moveAcceleration = .02, this._m = new THREE.Matrix4, this._oldMouseX = 0, this._oldMouseY = 0, this._moveWithKeys = n, this._moveAcceleration = new THREE.Vector3, this._moveVelocity = new THREE.Vector3, this._isDown = !1, this._initListeners()
        this.radius = {
            get () {
    ...
    onRemoved = function () {
        ...
        this._container.removeEventListener(e, this._onMouseWheel), this._container.removeEventListener("mousemove", this._onMouseMove), this._container.removeEventListener("touchmove", this._onTouchMove), this._container.removeEventListener("mousedown", this._onMouseDown), this._container.removeEventListener("touchstart", this._onTouchDown), this._container.removeEventListener("mouseup", this._onUp), this._container.removeEventListener("touchend", this._onUp), this._moveWithKeys && (document.removeEventListener("keyup", this._onKeyUp), document.removeEventListener("keydown", this._onKeyDown))
    }
    onUpdate = function (e) {
        if (this.enabled) {
            if (this._moveWithKeys) {
                this._moveVelocity.x *= this.dampen, this._moveVelocity.y *= this.dampen, this._moveVelocity.z *= this.dampen, this._moveVelocity.x += this._moveAcceleration.x, this._moveVelocity.y += this._moveAcceleration.y, this._moveVelocity.z += this._moveAcceleration.z;
    ...
    _initListeners = function () {
        ...
        this._onMouseWheel = function (t) {
            ...
            if (e._oldMouseX = void 0, e._oldMouseY = void 0, 2 === t.touches.length) {
                ...
                e._startPitchDistance = Math.sqrt(r * r + o * o), e._startZoom = e.radius
            }
            e._isDown = !0
...
class DebugAlphaMaterial extends THREE.ShaderMaterial {
    constructor(e) {
        super();
        var t = {
            map: {
...
class DebugVec3Material extends THREE.ShaderMaterial {
    constructor(e) {
        super();
        var t = {
            map: {
...
class GlassMaterial extends THREE.ShaderMaterial {
    constructor(e) {
        ...
        }), e.specularProbe && (this.uniforms.specularProbe.value = e.specularProbe), this.transparent = !0, this.blending = THREE.AdditiveBlending
    }
}
...
class SkyMaterial extends THREE.ShaderMaterial {
    constructor(e) {
        super();
        this._color = e.color || new THREE.Color(16777215), this._envMap = e.envMap;
        var t = {
            envMap: {
                value: this._envMap
            },
...
class RenderVolumeMaterial extends THREE.ShaderMaterial {
    constructor(e, t, n) {
        ...
        this.uniforms.skybox.value = t, this.extensions.fragDepth = !0, this.side = THREE.BackSide, this.transparent = !0
        ...
        this.mie = {
            ...
            set (e) {
                ...
                t.r = this._getMieFactor(e.r), t.g = this._getMieFactor(e.g), t.b = this._getMieFactor(e.b)
            }
        }
        this.roughness = {
            get () {
    ...
    update = function (e, t, n, i, r) {
        this.uniforms.lightAccum.value = n, this.uniforms.waterDepthMap.value = i, this.uniforms.sceneDepthMap.value = r, this.uniforms.viewMatrixInverse.value = t.matrixWorld, this.uniforms.unprojectionMatrix.value.getInverse(t.projectionMatrix), this.uniforms.cameraNear.value = t.near, this.uniforms.cameraRange.value = t.far - t.near;
        var o = this.uniforms.modelViewMatrixInverse.value;
        o.multiplyMatrices(t.matrixWorldInverse, e.matrixWorld), o.getInverse(o)
    }
    _getMieFactor = function (e) {
        var t = 1 - e,
            n = 1 + e * e + 2 * e;
...
class SPHParticlePointMaterial extends THREE.ShaderMaterial {
    constructor (e) {
        super();
        var t = {};
        e && (t.MAP = ""), THREE.ShaderMaterial.call(this, {
            defines: t,
            uniforms: {
                colorBuffer: {
                    value: e
...
class UnlitMaterial extends THREE.ShaderMaterial {
    constructor (e) {
        super();
        e = e || {};
        var t = "";
        e.color && (e.color = new THREE.Color(e.color), e.color.convertGammaToLinear()), (e.fogDensity || e.fogColor) && (t += "#define FOG\n"), e.hdre && !e.blending && (t += "#define HDRE\n"), e.map && (t += "#define ALBEDO_MAP\n");
        var n = {
            color: {
...
class CenteredGaussianCurve {
    constructor(e) {
        this._amplitude = 1 / Math.sqrt(2 * e * Math.PI), this._expScale = -1 / (2 * e)
    }
    getValueAt (e) {
        return this._amplitude * Math.pow(Math.E, e * e * this._expScale)
    }
    static fromRadius = function (e, t) {
        t = t || .01;
...
class PoissonDisk {
    constructor(e, t, n, i) {
        this.SQUARE = 0
        this.CIRCULAR = 1
        this._mode = void 0 === e ? PoissonDisk.CIRCULAR : e, this._initialDistance = t || 1, this._decayFactor = n || .99, this._maxTests = i || 2e4, this._currentDistance = 0, this._points = null, this.reset()
    }
    ...
    reset () {
        this._currentDistance = this._initialDistance, this._points = []
    }
    generatePoints (e) {
...
class PoissonSphere {
    constructor(e, t, n, i) {
        this.BOX = 0
        this.SPHERICAL = 1
        this._mode = void 0 === e ? PoissonSphere.SPHERICAL : e, this._initialDistance = t || 1, this._decayFactor = n || .99, this._maxTests = i || 2e4, this._currentDistance = 0, this._points = null, this.reset()
    }
    ...
    generatePoint () {
        for (;;) {
            for (var e = 0, t = this._currentDistance * this._currentDistance; e++ < this._maxTests;) {
                var n = this._getCandidate();
                if (this._isValid(n, t)) return this._points.push(n), n
            }
            this._currentDistance *= this._decayFactor
        }
    }
...
const BilateralGaussianBlurShader = {
    defines: {
        KERNEL_RADIUS: "5",
        NUM_WEIGHTS: "6"
    },
...
class SceneDepthRenderer {
    ...
    constructor(e, t, n) {
        this._renderer = t, this._scene = e, this._scale = n || 1, this._depthMaterial = new LinearDepthMaterial
    }
    ...
    resize(e, t) {
        e = Math.floor(e * this._scale), t = Math.floor(t * this._scale), this._renderTarget && this._renderTarget.width === e && this._renderTarget.height === t || (this._renderTarget = new THREE.WebGLRenderTarget(e, t, {
    ...
    render (e) {
        this._depthMaterial.cameraNear = e.near, this._depthMaterial.rcpCameraRange = 1 / (e.far - e.near), this._renderer.setClearColor(16777215, 1), this._scene.overrideMaterial = this._depthMaterial, this._renderer.render(this._scene, e, this._renderTarget, !0), this._scene.overrideMaterial = null, this._renderer.setClearColor(0, 1)
    }
}
...
class SimpleThreeProject {
    ...
    constructor() {
        this.scene = null, this.camera = null, this.renderer = null, this.assetLibrary = null, this.container = null, this.timeScale = 1, this._content = null, this._stats = null, this._renderStats = null, this._time = null, this._isRunning = !1, this._initialized = !1
    }
    init (e, t, n) {
        this._options = n || {}, this._options.alpha = this._options.alpha || !1, this._options.antialias = this._options.antialias || !1, this._options.preserveDrawingBuffer = this._options.preserveDrawingBuffer || !1, this.assetLibrary = t, this._initRenderer(), this._debugMode = e, e && this._initStats();
        var i = this;
        window.addEventListener("resize", function () {
            i._resizeCanvas()
        }, !1), this._content && this._content.init(this), this._initialized = !0, this._resizeCanvas()
    }
    get debugMode() {
    ...
    _initRenderer() {
        ...
        }), this.renderer.setPixelRatio(e), this.container = document.getElementById("webglcontainer"), this.scene = new THREE.Scene, this.camera = new THREE.PerspectiveCamera, this.camera.near = .1, this.camera.far = 100, this.scene.add(this.camera), this.container.appendChild(this.renderer.domElement)
    }
    _initStats () {
        this._stats = new Stats, this._stats.domElement.style.position = "absolute", this._stats.domElement.style.bottom = "0px", this._stats.domElement.style.right = "0px", this._stats.domElement.style.zIndex = 100, this.container.appendChild(this._stats.domElement), this._renderStats = new THREEx.RendererStats, this._renderStats.domElement.style.position = "absolute", this._renderStats.domElement.style.bottom = "0px", this._renderStats.domElement.style.zIndex = 100, this.container.appendChild(this._renderStats.domElement)
    }
    _resizeCanvas () {
        if (this.renderer) {
            var e = window.innerWidth,
                t = window.innerHeight;
            this.renderer.setSize(e, t), this.renderer.domElement.style.width = e + "px", this.renderer.domElement.style.height = t + "px", this.camera.aspect = e / t, this.camera.updateProjectionMatrix(), this._content && this._content.resize(this.renderer.domElement.width, this.renderer.domElement.height)
        }
    }
    stop () {
        this._isRunning = !1
    ...
    start () {
        this._isRunning = !0, this._content && this._content.start(), this._requestAnimationFrame()
    }
    _render () {
        if (this._isRunning) {
            var e = (new Date).getTime(),
                t = 0;
            null !== this._time && (t = e - this._time), t *= this.timeScale, this._time = e, this._requestAnimationFrame(), Entity.ENGINE.update(t), this._content && this._content.update(t), this._content && this._content.effectComposer ? this._content.effectComposer.render(t / 1e3) : this.renderer.render(this.scene, this.camera), this._stats && (this._renderStats.update(this.renderer), this._stats.update())
        }
    }
...
class SPHContent {
    constructor(e, t) {
        this.BALL_MODE = 0
        this.CASCADE_MODE = 1
        this._quality = t, this._mode = void 0 === e ? SPHContent.BALL_MODE : e
    }
    init (e) {
        ...
        this._spawnRatio = .003, this._mode === SPHContent.BALL_MODE ? this._setup = new SPHBallSetup : this._mode === SPHContent.CASCADE_MODE && (this._setup = new SPHCascadeSetup(this._assetLibrary.get("cascademap")), this._spawnRatio = .001), this._sph = new SPH(2, 2, 2, this._numParticles, this._volume, this._setup, this._renderer, this._quality), this._mie = new THREE.Color((-.01), (-.01), (-.011)), this._mie.multiplyScalar(1.5), this._fluidAbsorption = new THREE.Color(25, 3, 2), this._mode === SPHContent.CASCADE_MODE && (this._fluidAbsorption = new THREE.Color(8, 25, 23), this._sph.viscosity = 50, this._sph.stiffness = 3, this._sph.surfaceTension = .25), this._fluidAbsorption.multiplyScalar(3), this._particleDepthRenderer = new ParticleDepthRenderer(this._scene, this._renderer, this._sph, .5), this._sceneDepthRenderer = new SceneDepthRenderer(this._scene, this._renderer, .5), this._distanceFieldRenderer = new SPHDistanceFieldRenderer(this._renderer, this._sph),
    ...
    _onMouseUp (e) {
        this._dragging = !1, this._cameraController.enabled = !0
    }
    _onMouseMove (e) {
        if (this._dragging) {
            ...
            var n = this._rayCaster.ray.origin,
                ...
                r = (t - n.y) / i.y;
            this._blocker.position.x = THREE.Math.clamp(n.x + r * i.x, -2, 2), this._blocker.position.z = THREE.Math.clamp(n.z + r * i.z, -2, 2)
        }
    }
    _updateRaycaster (e, t) {
        e = e / window.innerWidth * 2 - 1, t = -(t / window.innerHeight * 2 - 1), this._rayCaster.setFromCamera(new THREE.Vector2(e, t), this._camera)
    }
    start () {}
    destroy () {}
    resize (e, t) {
        this._particleDepthRenderer.resize(window.innerWidth, window.innerHeight), this._sceneDepthRenderer.resize(window.innerWidth, window.innerHeight), this._fluidMaterial.pixelSize.x = 1 / e, this._fluidMaterial.pixelSize.y = 1 / t
    }
    update (e) {
        this._camera.updateMatrixWorld(!0), this._sph.spawn(this._numParticles * this._spawnRatio), this._mode === SPHContent.BALL_MODE ? (this._setup.collider.spherePosition = this._blocker.position, this._sph.update(16)) : this._sph.update(8), this._fluidMesh.visible = !1, this._sky.visible = !1, this._mode === SPHContent.CASCADE_MODE && (this._blocker.visible = !1), this._particleDepthRenderer.render(this._camera), this._sceneDepthRenderer.render(this._camera), this._distanceFieldRenderer.render(), this._fluidMesh.visible = !0, this._sky.visible = !0, this._mode === SPHContent.CASCADE_MODE && (this._blocker.visible = !0), this._lightingRenderer.render(this._distanceFieldRenderer.texture, this._fluidMesh, this._camera), this._fluidMaterial.update(this._fluidMesh, this._camera, this._lightingRenderer.texture, this._particleDepthRenderer.texture, this._sceneDepthRenderer.texture)
    }
    _initCameraController () {
        var e = new OrbitController(document.getElementById("webglcontainer"));
        e.azimuth = .5 * Math.PI,
        e.radius = 3, e.minRadius = 1,
        e.maxRadius = 1e3, e.zoomSpeed = 5,
        e.lookAtTarget.y = -.5
    ...
    _addLight (e, t, n) {
        ...
        i.position.set(e, t, n), this._scene.add(i), i = new THREE.DirectionalLight, i.position.set(e, t, n), this._lightingRenderer.addLight(i)
    }
    _initScene () {
        var e = this._sph.boxSize
        var t = this._assetLibrary.get("skybox");
        this._sky = new Skybox(t, 50), this._scene.add(this._sky), this._fluidMaterial = new RenderVolumeMaterial(this._sph, t, this._numVolumeSamples), this._fluidMaterial.absorption = this._fluidAbsorption, this._fluidMaterial.mie = this._mie;
        var n = new THREE.BoxBufferGeometry(e.x, e.y, e.z);
        this._fluidMesh = new THREE.Mesh(n, this._fluidMaterial), this._scene.add(this._fluidMesh), this._lightingRenderer = new VolumetricLightRenderer(this._renderer, this._sph.numCells, this._sph.cellSize, this._numLightSamples, (!0), .5), this._lightingRenderer.absorption = this._fluidAbsorption, this._lightingRenderer.mie = this._mie, this._addLight(1, .3, 1)
    }
    _initCollider () {
        ...
        this._blocker = new THREE.Mesh(t, n), this._blocker.position.y = .5 * -this._sph.boxSize.y + e, this._scene.add(this._blocker), this._setup.collider.sphereRadius = e, document.addEventListener("mousedown", this._onMouseDown.bind(this)), document.addEventListener("mouseup", this._onMouseUp.bind(this)), document.addEventListener("mousemove", this._onMouseMove.bind(this))
    }
    _initTerrain () {
        ...
        this._blocker = new THREE.Mesh(e, n), this._scene.add(this._blocker)
    }
}
...
class SPHDistanceFieldRenderer {
    constructor(e, t) {
        this._renderer = e, this._sph = t, this._numCells = t._numCells, this._cellSize = t.cellSize, this._zRange = Math.ceil(t.particleRadius / this._cellSize);
        ...
        this._distanceField = new THREE.WebGLRenderTarget(this._numCells.x * this._numCells.z, this._numCells.y, {
            ...
            stencilBuffer: !1,
            format: THREE.RGBAFormat
        }), this._material = new SPHDistanceMaterial(t), this._pointRenderer = new RectRenderer(e, new THREE.Points(t.pointGeometry))
    }
    ...
    render () {
        this._material.positionBuffer = this._sph.positionBuffer, this._renderer.setClearColor(new THREE.Color(1e3, 0, 0), 1), this._pointRenderer.clear(this._distanceField);
        for (var e = -this._zRange; e <= this._zRange; ++e) this._material.zSliceOffset = e, this._pointRenderer.execute(this._material, this._distanceField, !1);
...
class ParticleBlurredRenderer {
    ...
    resize (e, t) {
        e = Math.floor(e * this._scale), t = Math.floor(t * this._scale), this._renderTarget && this._renderTarget.width === e && this._renderTarget.height === t || (this._renderTarget = new DoubleBufferTexture(e, t, {
            type: this._textureType,
            minFilter: THREE.LinearFilter,
            magFilter: THREE.LinearFilter,
            generateMipmaps: !1,
    ...
    render (e) {
        this._renderParticles(e, this._renderTarget.target), this._renderTarget.swap(), this._blur()
    }
    _renderParticles (e, t) {
        throw new Error("Abstract method called!")
    }
    _blur () {
        this._blurMaterial.uniforms.tDiffuse.value = this._renderTarget.source, this._blurMaterial.uniforms.sampleStep.value.x = 1 / this._renderTarget.width, this._blurMaterial.uniforms.sampleStep.value.y = 0, this._rectRenderer.execute(this._blurMaterial, this._renderTarget.target, !0), this._renderTarget.swap(), this._blurMaterial.uniforms.tDiffuse.value = this._renderTarget.source, this._blurMaterial.uniforms.sampleStep.value.x = 0, this._blurMaterial.uniforms.sampleStep.value.y = 1 / this._renderTarget.height, this._rectRenderer.execute(this._blurMaterial, this._renderTarget.target, !0), this._renderTarget.swap()
    }
    _getGaussian (e) {
...
class ParticleDepthMaterial  extends THREE.ShaderMaterial {
    constructor(){
        super();
        this.uniforms = {
            positionBuffer: {
        ...
        this.vertexShader = ShaderLibrary.get("sph_particle_depth_vertex"),
        this.fragmentShader = ShaderLibrary.get("sph_particle_depth_fragment")
...
class ParticleDepthRenderer extends ParticleBlurredRenderer {

    constructor(e, t, n, i, r) {
        super(t, i, BilateralGaussianBlurShader, r)
        this._scene = e, this._particleSim = n, this._pointRenderer = new RectRenderer(t, new THREE.Points(n.pointGeometry)), this._depthMaterial = new ParticleDepthMaterial, this._depthMaterial.particleSize = n.particleRadius, r = void 0 === r ? 6 : r
        
    }
    

    _renderParticles = function (e, t) {
        this._depthMaterial.positionBuffer = this._particleSim.positionBuffer, this._depthMaterial.cameraNear = e.near, this._depthMaterial.rcpCameraRange = 1 / (e.far - e.near), this._renderer.setClearColor(16777215, 1), this._pointRenderer.execute(this._depthMaterial, t, !0, e), this._renderer.setClearColor(0, 1)
    }

    resize = function (e, t) {
        ParticleBlurredRenderer.prototype.resize.call(this, e, t), this._depthMaterial.viewportSize.x = this._renderTarget.width, this._depthMaterial.viewportSize.y = this._renderTarget.height
    }
}
...
class SPH {
    ...
    constructor(e, t, n, i, r, o, a, s) {
        this._setup = o, this._quality = s || SPH.Quality.LOW, this._volume = r, this._maxParticles = i, this._boxSize = new THREE.Vector3(e, t, n), this._restDensity = 998.29, this._particleMass = this._restDensity * r / this._maxParticles, this._smoothingRadius = Math.pow(3 * r * 20 / (4 * Math.PI * this._maxParticles), 1 / 3), this._cellSize = this._smoothingRadius / 2, this._particleRadius = .5 * Math.pow(3 * this._particleMass / (4 * Math.PI * this._restDensity), 1 / 3), this._restDistance = .1 * this._smoothingRadius, this._numCells = new THREE.Vector3(Math.ceil(e / this._cellSize), Math.ceil(t / this._cellSize), Math.ceil(n / this._cellSize)), this._halfExtent = this._boxSize.clone(), this._halfExtent.multiplyScalar(.5), this._halfExtent.x -= this._cellSize, this._halfExtent.y -= this._cellSize, this._halfExtent.z -= this._cellSize, this.viscosity = 3.5, this.stiffness = 3, this.surfaceTension = .0728, this.curvatureThreshold = 7.065, this.gravity = -9.81, this._numParticles = this._setup.getStartParticleCount(i), this._renderer = a, this._setup.collider.init(this, this._renderer), this._particleBufferSize = new THREE.Vector2(1024, Math.ceil(i / 1024)), this._bucketPixelSize = new THREE.Vector2(1 / (this._numCells.x * this._numCells.z), 1 / this._numCells.y), this._positionBuffer = new DoubleBufferTexture(this._particleBufferSize.x, this._particleBufferSize.y, this._rtOptions()), this._bucketBuffer = new THREE.WebGLRenderTarget(this._numCells.x * this._numCells.z, this._numCells.y, this._rtOptions(!0)), this._densityBuffer = new THREE.WebGLRenderTarget(this._particleBufferSize.x, this._particleBufferSize.y, this._rtOptions()), this._accelBuffer = new DoubleBufferTexture(this._particleBufferSize.x, this._particleBufferSize.y, this._rtOptions()), this._velocityBuffer = new DoubleBufferTexture(this._particleBufferSize.x, this._particleBufferSize.y, this._rtOptions()), this._bucketMaterial = new SPHBucketMaterial(this), this._densityMaterial = new SPHDensityMaterial(this), this._accelMaterial = new SPHAccelMaterial(this), this._velocityMaterial = new SPHVelocityMaterial(this), this._positionMaterial = new SPHPositionMaterial(this), this._pointGeometry = this._createPointGeometry(), this._renderPoints = new RectRenderer(a, new THREE.Points(this._pointGeometry)), this._renderRect = new RectRenderer(a), this._renderRect.clear(this._densityBuffer), this.reset()
    }
    ...
    spawn (e) {
        this._numParticles += Math.floor(e), this._numParticles > this._maxParticles && (this._numParticles = this._maxParticles)
    }
    reset () {
        this._numParticles = 0, this._initParticles(), this._renderer.setClearColor(0, 1), this._renderRect.clear(this._accelBuffer.target), this._accelBuffer.swap(), this._renderRect.clear(this._accelBuffer.target), this._accelBuffer.swap(), this._renderRect.clear(this._velocityBuffer.target), this._velocityBuffer.swap()
    }
    _initParticles () {
        for (var e = new THREE.Vector3, t = [], n = 0; n < this._maxParticles; ++n) this._setup.initParticlePosition(n, this._maxParticles, this._halfExtent, e), t.push(e.x, e.y, e.z, n + 1);
        ...
        CopyDataToRenderTarget.execute(r, this._positionBuffer.target, this._renderer, THREE.FloatType), this._positionBuffer.swap()
    }
    _createPointGeometry () {
        for (var e = new THREE.BufferGeometry, t = [], n = [], i = [], r = this._particleBufferSize.x, o = this._particleBufferSize.y, a = 0; a < this._maxParticles; ++a) {
            var s = Math.floor(a / r),
                l = a - s * r;
            l = (l + .5) / r, s = (s + .5) / o, i.push(l, s), n.push(a), t.push(a)
        }
        return e.setIndex(new THREE.BufferAttribute(new Uint32Array(t), 1)), e.addAttribute("positionUV", new THREE.BufferAttribute(new Float32Array(i), 2)), e.addAttribute("particleIndex", new THREE.BufferAttribute(new Float32Array(n), 1)), e
    }
    update (e, t) {
        e *= .001, 0 === e && (e = .01), this._pointGeometry.setDrawRange(0, this._numParticles), this._setup.collider.update(), t = 2 | t, e /= t;
        for (var n = 0; n < t; ++n) this._updateBucket(), this._updateDensity(), this._updateAccel(e), this._updateVelocity(e), this._updatePosition(e)
    }
    _updateBucket () {
        var e = this._renderer.context;
        this._bucketMaterial.positionBuffer = this._positionBuffer.source, this._bucketMaterial.numParticles = this._maxParticles, this._bucketMaterial.depthFunc = THREE.LessDepth;
        var t = this._renderer.state.buffers.stencil;
        t.setMask(255), t.setClear(0), t.setTest(!0), t.setOp(e.KEEP, e.KEEP, e.KEEP), t.setFunc(e.ALWAYS, 0, 255), this._renderer.setClearColor(0, 0), this._renderBucketPass(!0, !1, !1, !1, !0), t.setOp(e.KEEP, e.KEEP, e.INCR), t.setFunc(e.GREATER, 1, 255), this._bucketMaterial.depthFunc = THREE.GreaterDepth, this._renderBucketPass(!1, !0, !1, !1, !1), this._renderBucketPass(!1, !1, !0, !1, !1), this._renderBucketPass(!1, !1, !1, !0, !1), t.setTest(!1), t.setOp(e.KEEP, e.KEEP, e.KEEP), t.setFunc(e.ALWAYS, 0, 4294967295)
    }
    _renderBucketPass (e, t, n, i, r) {
        var o = this._renderer.state.buffers.color;
        this._renderer.clearTarget(this._bucketBuffer, r, r, !0), o.setMask(e, t, n, i), o.setLocked(!0), this._renderPoints.execute(this._bucketMaterial, this._bucketBuffer, !1), o.setLocked(!1)
    }
    _updateDensity () {
        this._densityMaterial.positionBuffer = this._positionBuffer.source, this._densityMaterial.bucketBuffer = this._bucketBuffer.texture, this._densityMaterial.particleMass = this.particleMass, this._renderRect.execute(this._densityMaterial, this._densityBuffer)
    }
    _updateAccel (e) {
        this._accelMaterial.positionBuffer = this._positionBuffer.source, this._accelMaterial.bucketBuffer = this._bucketBuffer.texture, this._accelMaterial.densityBuffer = this._densityBuffer.texture, this._accelMaterial.velocityBuffer = this._velocityBuffer.source, this._accelMaterial.restDensity = this.restDensity, this._accelMaterial.particleMass = this.particleMass, this._accelMaterial.viscosity = this.viscosity, this._accelMaterial.stiffness = this.stiffness, this._accelMaterial.gravity = this.gravity, this._accelMaterial.curvatureThreshold = this.curvatureThreshold, this._accelMaterial.surfaceTension = this.surfaceTension, this._accelMaterial.maxParticleIndex = this._numParticles + 1, this._accelMaterial.dt = e, this._renderRect.execute(this._accelMaterial, this._accelBuffer.target), this._accelBuffer.swap()
    }
    _updatePosition (e) {
        this._positionMaterial.positionBuffer = this._positionBuffer.source, this._positionMaterial.velocityBuffer = this._velocityBuffer.source, this._positionMaterial.accelBuffer = this._accelBuffer.source, this._positionMaterial.maxParticleIndex = this._numParticles + 1, this._positionMaterial.dt = e, this._renderRect.execute(this._positionMaterial, this._positionBuffer.target), this._positionBuffer.swap()
    }
    _updateVelocity (e) {
        this._velocityMaterial.positionBuffer = this._positionBuffer.source, this._velocityMaterial.velocityBuffer = this._velocityBuffer.source, this._velocityMaterial.accelBuffer1 = this._accelBuffer.source, this._velocityMaterial.accelBuffer2 = this._accelBuffer.target.texture, this._velocityMaterial.maxParticleIndex = this._numParticles + 1, this._velocityMaterial.dt = e, this._renderRect.execute(this._velocityMaterial, this._velocityBuffer.target), this._velocityBuffer.swap()
    }
    _rtOptions (e) {
        return {
...
class SPHAccelMaterial extends THREE.ShaderMaterial{
    constructor (e) {
        var t = {
...
class SPHBallCollider extends SPHCollider{
    constructor() {
    ...
    static sphereRadius = {
        ...
        set (e) {
            this._material.sphereRadius !== e && this.invalidate(), this._material.sphereRadius = e
        }
    }
    static spherePosition = {
        get () {
            return this._material.spherePosition
        },
        set (e) {
            this._material.spherePosition.equals(e) || this.invalidate(), this._material.spherePosition = e
        }
    }
...
class SPHBallColliderMaterial extends THREE.ShaderMaterial {
    constructor(){
        super({
            uniforms: {
                wallExtent: {
...
class SPHBallSetup {
    ...
    getStartParticleCount (e) {
        return 0
    }
    getInitVelocityGLSL () {
        return ShaderLibrary.getInclude("sph_init_velocity_stream")
    }
    initParticlePosition (e, t, n, i) {
        var r = new THREE.Spherical;
        return function (e, t, n, i) {
            var o = n.length() / 6;
            r.radius = Math.random() * o, r.phi = Math.random() * Math.PI, r.theta = Math.random() * Math.PI * 2, i.setFromSpherical(r), i.x -= .5 * n.x, i.y += .5 * n.y, i.z -= .5 * n.z
        }
    }
}

class SPHBucketMaterial extends THREE.ShaderMaterial {
    constructor(e) {
        super({
            uniforms: {
                positionBuffer: {
...
class SPHCascadeSetup {
    ...
    initParticlePosition (e, t, n, i) {
        i.x = -n.x * (.2 * Math.random() + .8), i.y = .9 * n.y, i.z = (2 * Math.random() - 1) * n.z * .2
    }
}

class SPHDensityMaterial extends THREE.ShaderMaterial {
    constructor(e) {
        var t = {
            SAMPLE_RADIUS: e.quality,
            BUCKET_SIZE: 4
...
class SPHDistanceMaterial extends THREE.ShaderMaterial{
    ...
    constructor (e) {
        ...
        this.blending = THREE.CustomBlending, this.blendEquation = THREE.MinEquation, this.blendSrc = THREE.ONE, this.blendDst = THREE.ONE, this.transparent = !0
        this.positionBuffer = {
            get () {
                return this.uniforms.positionBuffer.value
            },
...
class SPHHeightMapCollider extends SPHCollider {
    constructor(e) {
...
class SPHHeightMapColliderMaterial extends THREE.ShaderMaterial {
    constructor (e) {
        super({
            uniforms: {
                numCells: {
...
class SPHPositionMaterial extends THREE.ShaderMaterial {
    constructor (e) {
        super({
            uniforms: {
                positionBuffer: {
...
class SPHVelocityMaterial extends THREE.ShaderMaterial {
    constructor (e) {
        super( {
            uniforms: {
                positionBuffer: {
...
class SPHWallCollider extends SPHCollider {
    constructor() {
...
class SPHWallColliderMaterial extends THREE.ShaderMaterial {
    constructor () {
        super( {
            uniforms: {
                numCells: {
...
class VolumetricLighting extends THREE.ShaderMaterial {
    constructor(e, t, n, i) {
        var r = {
            NUM_SAMPLES: n
        };
...
VolumetricLightRenderer.prototype = {
    ...
    render (e, t, n) {
        ...
        r.copy(n.position), r.applyMatrix4(i), this._material.densityField = e, this._rectRenderer.execute(this._material, this._target, !0)
    }
}
...
VolumetricNormalsRenderer.prototype = {
    render (e, t) {
        this._material.densityField = e, this._renderer.render(this._scene, this._camera, t, !0)
    }
};
