...
function startUp() {
    ...
    assetLibrary.queueAsset("G", "objects/G.obj", AssetLibrary.Type.MODEL)

    assetLibrary.onComplete.bind(onAssetsLoaded)
    assetLibrary.onProgress.bind(onAssetsProgress), assetLibrary.load()
}
...
function start(e, t) {
    e = SPH.Quality.EXTREME
    t = SPHContent.CASCADE_MODE
    var n = document.getElementById("playContainer");
...
function ParticleBlurredRenderer(e, t, n, i, r) {
    this._textureType = r, this._renderer = e, this._scale = t || 1, n.defines.KERNEL_RADIUS = i, n.defines.NUM_WEIGHTS = i + 1, this._blurMaterial = new THREE.ShaderMaterial(n), this._blurMaterial.uniforms.weights.value = this._getGaussian(i), this._blurMaterial.depthTest = !1, this._blurMaterial.depthWrite = !1, this._rectRenderer = new RectRenderer(e), this.resize(window.innerWidth, window.innerHeight)
}

function ParticleDepthRenderer(e, t, n, i, r) {
    this._scene = e, this._particleSim = n, this._pointRenderer = new RectRenderer(t, new THREE.Points(n.pointGeometry)), this._depthMaterial = new ParticleDepthMaterial, this._depthMaterial.particleSize = n.particleRadius, r = void 0 === r ? 6 : r, ParticleBlurredRenderer.call(this, t, i, BilateralGaussianBlurShader, r)
}
...
}, Axes.prototype = Object.create(THREE.Object3D.prototype), Axes.prototype._init = function () {
...
RectRenderer.prototype = {
        execute: function (e, t, n, i) {
            ...
            this._renderer.autoClear = void 0 === n || n, this._mesh.material = e
        ...
        addComponent: function (e, t) {
            ...
            Entity.convert(e), e._components.push(t), e._updateRequiresUpdates(this._requiresUpdates || !!t.onUpdate), t._entity = e, t.onAdded()
        },
...
window.onload = startUp, AssetLibrary = function (e) {
...
}), BillboardComponent.prototype.onAdded = function () {}, BillboardComponent.prototype.onRemoved = function () {}, BillboardComponent.prototype.onUpdate = function (e) {
    ...
    this._container.addEventListener(e, this._onMouseWheel), this._container.addEventListener("mousemove", this._onMouseMove), this._container.addEventListener("touchmove", this._onTouchMove), this._container.addEventListener("mousedown", this._onMouseDown), this._container.addEventListener("touchstart", this._onTouchDown), this._container.addEventListener("mouseup", this._onUp), this._container.addEventListener("touchend", this._onUp), this._moveWithKeys && (document.addEventListener("keyup", this._onKeyUp), document.addEventListener("keydown", this._onKeyDown))
...
}, DielectricMaterial.prototype = Object.create(THREE.ShaderMaterial.prototype), GlassMaterial = function (e) {
    var t = "";
...
}, GlassMaterial.prototype = Object.create(THREE.ShaderMaterial.prototype), LinearDepthMaterial = function () {
    THREE.ShaderMaterial.call(this, {
        uniforms: {
            cameraNear: {
                value: 0
...
}, UnlitMaterial.prototype = Object.create(THREE.ShaderMaterial.prototype), Gaussian = {
...
}, PoissonDisk.SQUARE = 0, PoissonDisk.CIRCULAR = 1, PoissonDisk.prototype = {
    getPoints: function () {
        return this._points
    },
    reset: function () {
...
}, PoissonSphere.BOX = 0, PoissonSphere.SPHERICAL = 1, PoissonSphere.prototype = {
    getPoints: function () {
        return this._points
    },
    reset: function () {
    ...
    set content(e) {
        this._time = null, this._content && this._content.destroy(), this._content = e, this._initialized && this._content.init(this), this._isRunning && this._content.start(), this._resizeCanvas()
    },
...
}, SPHContent.BALL_MODE = 0, SPHContent.CASCADE_MODE = 1, SPHContent.prototype = {
    init: function (e) {
        this._numLightSamples = 10
        this._numVolumeSamples = this._quality === SPH.Quality.HIGH ? 2 : 2
        this._volume = 1
        this._numParticles = this._quality === SPH.Quality.EXTREME ? 50240 : 50240
        this._scene = e.scene
        window.THREE = THREE;
        ...
        this._spawnRatio = 1, 
        this._mode === SPHContent.CASCADE_MODE && 
        (this._setup = new SPHCascadeSetup(this._assetLibrary.get("cascademap")), 
        this._spawnRatio = 1), 
        this._sph = new SPH(1.9,1.9,1.9,
        this._numParticles, 
        this._volume, 
        this._setup, 
        this._renderer, 
        this._quality), 
        this._mie = new THREE.Color((-.01), 
        (-.01), 
        (-.011)), 
        this._mie.multiplyScalar(1.5), 
        this._fluidAbsorption = new THREE.Color(1, 
        3, 
        2), 
        this._mode === SPHContent.CASCADE_MODE && (this._fluidAbsorption = new THREE.Color(50, 
            3, 
            2), 
        this._sph.viscosity = 10, 
        this._sph.stiffness = 1, 
        this._sph.surfaceTension = .1
        ), 
        this._fluidAbsorption.multiplyScalar(3), 
        this._particleDepthRenderer = new ParticleDepthRenderer(this._scene, 
        this._renderer, 
        this._sph, 
        .5), 
        this._sceneDepthRenderer = new SceneDepthRenderer(this._scene, 
        this._renderer, 
        .5), 
        this._distanceFieldRenderer = new SPHDistanceFieldRenderer(this._renderer, 
        this._sph),
    ...
    destroy: function () {},
    resize: function (e, t) {
        this._particleDepthRenderer.resize(window.innerHeight, window.innerHeight), this._sceneDepthRenderer.resize(window.innerHeight, window.innerHeight), this._fluidMaterial.pixelSize.x = 1 / e, this._fluidMaterial.pixelSize.y = 1 / t
    },
    update: function (e) {
    ...
    _initCameraController: function () {
        ...
        e.azimuth = .5 * Math.PI, e.radius = 3, e.minRadius = 1, e.maxRadius = 1e3, e.zoomSpeed = 5, e.lookAtTarget.y = -.5, e.maxPolar = .5 * Math.PI + .1, Entity.addComponent(this._camera, e), this._cameraController = e, this._mode === SPHContent.CASCADE_MODE && (e.maxAzimuth = .5 * Math.PI - .5, e.minAzimuth = .5 * -Math.PI + .5)
        */
    },
    ...
    _initScene: function () {
        ...
        this._sky = new Skybox(t, 50), this._scene.add(this._sky)
        ...
        this._lightingRenderer.absorption = this._fluidAbsorption, this._lightingRenderer.mie = this._mie
        this._addLight(1, .3, 1)
    },
    _initCollider: function () {
        this._rayCaster = new THREE.Raycaster;
        console.log(this._assetLibrary.get("G"));
        var e = .10,
            t = this._assetLibrary.get("G").geometry  //new THREE.SphereBufferGeometry(e, 30, 20),
    ...
    _initTerrain: function () {
        var e = new THREE.PlaneBufferGeometry(this._sph.boxSize.x, this._sph.boxSize.z, 124, 124);
        e.rotateX(.5 * -Math.PI);
...
}), ParticleDepthRenderer.prototype = Object.create(ParticleBlurredRenderer.prototype), ParticleDepthRenderer.prototype._renderParticles = function (e, t) {
...
SPHBallCollider.prototype._updateMaterial = function () {}, SPHBallColliderMaterial = function () {
    THREE.ShaderMaterial.call(this, {
        uniforms: {
            wallExtent: {
                value: null
...
}), SPHHeightMapCollider.prototype = Object.create(SPHCollider.prototype), SPHHeightMapColliderMaterial = function (e) {
    THREE.ShaderMaterial.call(this, {
        uniforms: {
            numCells: {
                value: null
...
}, SPHHeightMapColliderMaterial.prototype = Object.create(THREE.ShaderMaterial.prototype), SPHPositionMaterial = function (e) {
    THREE.ShaderMaterial.call(this, {
        uniforms: {
            positionBuffer: {
                value: null
...
}), SPHWallCollider.prototype = Object.create(SPHCollider.prototype), SPHWallColliderMaterial = function () {
    THREE.ShaderMaterial.call(this, {
        uniforms: {
            numCells: {
                value: null
...
}, SPHWallColliderMaterial.prototype = Object.create(THREE.ShaderMaterial.prototype), VolumetricLighting.prototype = Object.create(THREE.ShaderMaterial.prototype, {
    densityField: {
        get: function () {
